<h2> Tambah Kurikulum Semester 1 </h2>
...
<?php
  if(isset($_POST["save"]))
 {
    ...
    $ambil = $koneksi->query("SELECT * FROM tb_matkul1 WHERE kode_matkul='$kode'");
    ...
    else
    {
        ...
        $koneksi->query("INSERT INTO tb_matkul1 ( kode_matkul, kode_kurikulum, nama_matkul, sks, syarat)
